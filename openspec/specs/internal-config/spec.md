...
> Spec for the `internal/config` package. Covers the test surface for
> settings-key helpers, wildcard ignore patterns, Load/Save error paths,
> and Get/Set error paths.
