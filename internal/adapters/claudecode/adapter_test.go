...
func TestAdapter_Backup_DirectoryItems(t *testing.T) {
	...
	items := []adapters.Item{
		{Category: "skills", SourcePath: "~/.claude/myskills", RelPath: "myskills", IsDir: true},
		{Category: "skills", SourcePath: "~/.claude/myskills/code-review.md", RelPath: "myskills/code-review.md", IsDir: false, Hash: "sha256:abc", Size: 13},
	}
	...
	dirDst := filepath.Join(backupDir, "claude-code", "myskills")
	...
	fileDst := filepath.Join(backupDir, "claude-code", "myskills", "code-review.md")
...
func TestAdapter_Backup_CopyError(t *testing.T) {
	...
	items := []adapters.Item{
		{Category: "config", SourcePath: "~/.claude/unreadable.txt", RelPath: "unreadable.txt", IsDir: false, Hash: "sha256:abc", Size: 4},
	}
...
func TestAdapter_Restore_CopyError(t *testing.T) {
	...
	backupDir := filepath.Join(t.TempDir(), "backup")
	srcFile := filepath.Join(backupDir, "claude-code", "secret.json")
	...
	items := []adapters.Item{
		{Category: "config", SourcePath: "~/.claude/secret.json", RelPath: "secret.json", IsDir: false, Hash: "sha256:xyz", Size: 16},
	}
