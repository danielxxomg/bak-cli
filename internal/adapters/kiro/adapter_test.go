...
func TestAdapter_Backup_DirectoryItems(t *testing.T) {
	...
	items := []adapters.Item{
		{Category: "skills", SourcePath: "~/.kiro/myskills", RelPath: "myskills", IsDir: true},
		{Category: "skills", SourcePath: "~/.kiro/myskills/code-review.md", RelPath: "myskills/code-review.md", IsDir: false, Hash: "sha256:abc", Size: 13},
	}
	...
	dirDst := filepath.Join(backupDir, "kiro", "myskills")
	...
	fileDst := filepath.Join(backupDir, "kiro", "myskills", "code-review.md")
...
func TestAdapter_Backup_CopyError(t *testing.T) {
	...
	items := []adapters.Item{
		{Category: "config", SourcePath: "~/.kiro/unreadable.txt", RelPath: "unreadable.txt", IsDir: false, Hash: "sha256:abc", Size: 4},
	}
...
func TestAdapter_Restore_CopyError(t *testing.T) {
	...
	backupDir := filepath.Join(t.TempDir(), "backup")
	srcFile := filepath.Join(backupDir, "kiro", "secret.json")
	...
	items := []adapters.Item{
		{Category: "config", SourcePath: "~/.kiro/secret.json", RelPath: "secret.json", IsDir: false, Hash: "sha256:xyz", Size: 16},
	}
